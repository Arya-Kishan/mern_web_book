...
const InterviewPage = () => {
  ...
  return (
    <div className='w-full h-full relative'>
      ...
      <div className='w-full h-[calc(100dvh-70px)] md:h-[calc(100dvh-125px)] overflow-scroll flex flex-wrap justify-start items-start gap-5 pt-5 mobileBottomPadding'>
