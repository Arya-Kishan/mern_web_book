...
const Profile = () => {
  ...
  console.log("LOGGED IN SUER : ", loggedInUser);
  ...
  } = useGetSingleUserQuery(params.userId);
    ...
    <>
      <div className="w-full h-fit flex justify-between relative">
        <div className="w-full flex gap-2 md:gap-10 items-center justify-start text-[20px] sm:text-[40px] mr-4 overflow-hidden">
          <div className="w-[50px] h-[50px] md:w-[100px] md:h-[100px]">
            <MyImage
              ...
              src={`https://api.multiavatar.com/${userDetail.name}.svg`}
            />
          </div>
        ...
        <div
          ...
          className="w-fit h-full flex flex-col justify-between items-center gap-5 relative"
        >
          <MyImage
            className={`w-[20px] h-[20px] md:w-[30px] md:h-[30px] transition-all duration-700 ${
              setting ? "rotate-0" : "rotate-90"
            }`}
            src={settingIcon}
          ...
          {setting && (
            <div className="w-[250px] h-[200px] absolute top-[14px] right-[14px] md:top-[24px] md:right-[24px] bg-bgNotePop text-white rounded-xl p-2">
              ...
              <div className="flex flex-row justify-start items-center gap-2">
                ...
                <p className="p-2 cursor-pointer">
                  Notification : {userDetail.FCMtoken.pushPermission}
                </p>
              </div>
