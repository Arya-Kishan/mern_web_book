...
const NotePage = () => {
  ...
  return (
    <div className='w-full h-full'>
      ...
      <div className='w-full h-[calc(100dvh-65px)] md:h-[calc(100dvh-120px)] overflow-scroll flex flex-col md:flex-row gap-5 justify-start items-start pt-5 pb-12 md:pb-0'>
