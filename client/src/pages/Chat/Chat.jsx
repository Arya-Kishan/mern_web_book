...
const Chat = () => {
  ...
  const handleToggle = (word) => {
    if (word == "save") {
      ...
      globalSocket.emit("send-changed-conversationType", {
  ...
  return (
    <div className="w-full h-full">
      <div className="w-full h-[32px] flex justify-between">
        <div className="flex items-center gap-4">
          <MyImage
            ...
            onClick={() => {}}
            src={`https://api.multiavatar.com/${opponentName}.svg`}
            alt=""
          />
        ...
        <div className="w-[100px] md:w-[200px] flex gap-1">
          <div className="w-[300px] flex gap-1 items-center">
            <div
              ...
              className={`flex gap-1 items-center w-[60px] md:w-[100px] rounded-2xl justify-center p-1 ${
                conversationType == "save"
                  ? "bg-bgHistoryPop"
                  : "bg-transparent"
              }`}
      ...
      <div>
        {conversationType == "save" ? <SaveMessage /> : <NotSaveMessage />}
      </div>
    </div>
  );
};
