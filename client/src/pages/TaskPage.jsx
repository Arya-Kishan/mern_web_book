  ...
  return (
    <div className='w-full h-full'>
      ...
      {isLoading
        ...
        <Loader />
        :
        <div className='w-full h-fit sm:h-[calc(100dvh-65px)] md:h-[calc(100dvh-120px)] overflow-scroll flex flex-wrap justify-start items-start gap-5 pt-5 mobileBottomPadding'>
