    ...
    return (
        <div className='w-full flex gap-2'>
            ...
            {!editComment.showEditBtn
                ?
                <input className='w-full p-1 outline-none text-black rounded-md' onKeyUp={handleEnter} value={input} onChange={e => setInput(e.target.value)} type="text" placeholder='your comment ...' />
                :
                <div className='w-full flex justify-evenly items-center gap-1 bg-white rounded-md overflow-hidden'>
                    <input className='w-full p-1 outline-none text-black' onKeyUp={handleEnter} value={input} onChange={e => setInput(e.target.value)} type="text" placeholder="your comment..." />
            ...
            {!editComment.showEditBtn
                ?
                <LoaderButton text={"Add"} loading={addPostCommentLoading} onClick={handleAddComment} bgColor='bg-blue-500' width='80px' />
                :
                <LoaderButton text={"Edit"} loading={editPostCommentLoading} onClick={handleEditComment} bgColor='bg-blue-500' width='80px' />
            }
