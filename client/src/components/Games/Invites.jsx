...
const Invites = ({ handleAcceptUserInvitation, setShow, game = "Tic Tac Toe" }) => {
    ...
    return (
        <div onClick={
            ...
            <div onClick={e => e.stopPropagation()} className='w-[300px] sm:w-[400px] h-[300px] bg-teal-800 p-4 rounded-xl flex flex-col justify-start items-center gap-4 capitalize overflow-scroll text-[14px]'>
