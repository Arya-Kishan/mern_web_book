    ...
    return (
        <div className='flex flex-col gap-3 justify-evenly items-start bg-gradient-to-r from-blue-900 to-bg-card rounded-lg w-full md:w-[48%] lg:w-[31.5%] h-[200px] p-2 cursor-pointer'>
            ...
            <div className='w-full flex justify-start items-center'>
                <button onClick={() => navigate(`/mcqDetail/${mcq.mcqType == "personal" ? mcq._id : mcq.mcqId}?title=${mcq.title}`)} className='w-[100px] text-textColor4 font-semibold bg-bgBtn1 p-2 rounded-lg'>Check</button>
            </div>
