...
const DeletePopUp = ({
  ...
  const [
    deleteInterview,
    { isLoading: InterviewLoading, isSuccess: InterviewSuccess },
  ] = useDeleteInterviewMutation();
  const [deleteMcq, { isLoading: mcqLoading, isSuccess: mcqSuccess }] =
    useDeleteMcqMutation();
  const [
    deleteQuestion,
    { isLoading: questionLoading, isSuccess: questionSuccess },
  ] = useDeleteQuestionMutation();
  const [
    deleteOptions,
    { isLoading: optionLoading, isSuccess: optionSuccess },
  ] = useDeleteOptionsMutation();
  const [
    deleteGlobalMcq,
    { isLoading: GlobalMcqLoading, isSuccess: GlobalMcqSuccess },
  ] = useDeleteGlobalMcqMutation();
  const [
    deleteGlobalInterview,
    { isLoading: GlobalInterviewLoading, isSuccess: GlobalInterviewSuccess },
  ] = useDeleteGlobalInterviewMutation();
  const [deletePost, { isLoading: postLoading, isSuccess: postSuccess }] =
    useDeletePostMutation();
  const [
    deleteConversationMessages,
    {
      isLoading: deleteConversationMessagesLoading,
      isSuccess: deleteConversationMessagesSuccess,
    },
      ...
      <div className="w-full lg:w-[60%] flex justify-around gap-5 text-[13px] text-1xl">
        <LoaderButton
          ...
          loading={
            ...
            questionLoading ||
            GlobalMcqLoading ||
            GlobalInterviewLoading ||
            postLoading ||
            deleteConversationMessagesLoading
          }
